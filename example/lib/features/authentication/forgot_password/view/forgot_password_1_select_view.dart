          ...
          child: Column(
            children: [
              HelperWidget.imageWidget(
                Assets.images.authenication.selectTypeChangePassword.path,
                height: 200,
              ),
              const Padding(
                padding: EdgeInsets.all(AppConstants.paddingTextField * 2),
                child: Text(
                  "Lựa chọn phương án xác minh\ntài khoản",
              ...
              ...{
                ...
                "mail": {
                  ...
                  "subtitle": "datz***123@gmail.com",
                  "icon": Icons.email,
                  "type": ForgotPassWordType.email,
                },
              }.entries.map(
                  ...
                  builder: (context, forgotPassWordTypeValue, child) {
                    ...
                    return Padding(
                      padding: const EdgeInsets.only(
                        bottom: AppConstants.paddingTextField,
                      ),
                      child: InkWell(
                          ...
                          decoration: BoxDecoration(
                            border: Border.all(
                              color: isSelected
                                  ...
                                  : MyHelperWidget.borderSide(context).color,
                              width: isSelected
                                  ? 1
                                  : MyHelperWidget.borderSide(context).width,
                            ),
                            borderRadius: AppConstants.borderRadius,
