            ...
            ...[
              ...
              SettingMenuWidget(
                ...
                onTap: () => launchUrlString(
                  "${GetIt.instance<DioNetworkService>().baseUrl}/intro",
                ),
              ),
              SettingMenuWidget(
                ...
                onTap: () => launchUrlString(
                  "${GetIt.instance<DioNetworkService>().baseUrl}/privacy-policy",
                ),
              ),
              SettingMenuWidget(
                ...
                iconColor: Colors.blue,
                onTap: () => launchUrlString(
                  "${GetIt.instance<DioNetworkService>().baseUrl}/terns-of-use",
                ),
              ),
              SettingMenuWidget(
                title: "Liên hệ".tr(),
                ...
                onTap: () => showModalBottomSheet(
                  context: context,
                  builder: (context) => const BuildContactInfoBottomSheet(),
                ),
              ),
              SettingMenuWidget(
                title: "Feedback".tr(),
                ...
                iconColor: Colors.orange,
                onTap: () => launchUrlString(
                  "${GetIt.instance<DioNetworkService>().baseUrl}/feedback",
                ),
              ),
            ].map(
              (e) => Padding(
                padding: const EdgeInsets.only(
                  bottom: (AppConstants.paddingTextField / 2),
                ),
                child: e,
              ),
            ),
