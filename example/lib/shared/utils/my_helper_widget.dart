...
final class MyHelperWidget {
  ...
  static EdgeInsetsGeometry bottomPaddingIOS({
    double horizontal = AppConstants.paddingContent,
  }) => Platform.isIOS
      ? EdgeInsets.only(
      ...
      builder: (context) {
        ...
        return ValueListenableBuilder(
          ...
          builder: (context, dataValue, child) {
            final ValueNotifier<List<T>> search = ValueNotifier(
              dataValue.toList(),
            );
            return AlertDialog(
